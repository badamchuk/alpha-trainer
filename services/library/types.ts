...
export interface LibraryExercise {
  ...
  /** 2–4 короткі підказки техніки (українською). */
  cues: string[];
  /**
   * Те саме англійською. Заповнене не скрізь: поки перекладу немає, показуємо
   * українське — краще корисна підказка чужою мовою, ніж порожнє місце.
   */
  cuesEn?: string[];
  /** Ті самі варіанти англійською; без них в English-режимі їх не показуємо. */
  modificationsEn?: string[];
  defaultReps?: number;
